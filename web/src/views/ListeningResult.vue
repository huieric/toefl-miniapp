    ...
    <div class="card" v-if="result">
      <div class="result-summary">
        ...
        <div class="summary-detail">
          <p><strong>题目：</strong>{{ result.title || '听力理解' }}</p>
        ...
        <el-button type="primary" class="action-btn" @click="$router.push('/listening')">继续练习</el-button>
      </div>
    </div>
...
@media (max-width: 600px) {
  .summary-detail { padding: 12px 14px; font-size: 13px; }
  .summary-detail p { font-size: 13px; }
}
</style>
