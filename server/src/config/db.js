...
const COLUMN_DEFS = [
  ...
  { table: 'user_stats', name: 'focus_minutes',     type: 'INTEGER', def: '0' },
  { table: 'user_stats', name: 'total_focus_sessions', type: 'INTEGER', def: '0' },
  { table: 'user_stats', name: 'xp_points',         type: 'INTEGER', def: '0' },
  { table: 'user_stats', name: 'streak_freeze_count', type: 'INTEGER', def: '0' },
  { table: 'daily_goals', name: 'study_minutes',     type: 'INTEGER', def: '30' },
  { table: 'daily_goals', name: 'target_questions',   type: 'INTEGER', def: '20' },
  { table: 'daily_goals', name: 'completed',         type: 'BOOLEAN', def: 'FALSE' },
